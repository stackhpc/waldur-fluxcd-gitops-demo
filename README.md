...
**Horizon Application Credentials	[2](#heading=h.x5u0l8hx0kbh)**

Create/Delete Credentials	[2](#heading=h.jltys38rhgql)

- How to create & delete application credentials within Horizon.

**Processing Secrets	3**

Encrypting Credentials	3
...
Deleting Old Secrets	5

- Some housekeeping steps post secret rotation.

Rotating Compromised Secrets	5
